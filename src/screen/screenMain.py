...
labelImgPlay = tk.CTkButton(master=window, image=imgPlay, text=None, fg_color=darkgrey, command=test, background_corner_colors=None)
labelImgPlay.place(x=350-60, y=415)
